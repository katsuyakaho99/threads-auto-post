...
# ===== 2026年8月度（新規案件・月額）=====
aug_items = [
    ("8月度 業務委託料（試用期間・月額）", 100000, 8000),
    ("8月 交通費（阿波座↔森ノ宮 往復）", 6720, 0),
]
aug_remarks = [
    "月額：試用期間につき ¥100,000 ＋ 税8%（調整額 ¥8,000）",
    "",
    "交通費：阿波座↔森ノ宮　往復 ¥480/日（片道 ¥240×2）",
    "対象日：8/5・6・7・10・12・17・18・19・20",
    "　　　　8/24・25・26・28・31（計14日）",
    "¥480 × 14日 = ¥6,720",
]
build(os.path.join(BASE, "請求書_株式会社蒼蓮_2026年8月.pdf"),
      "2026-08", "2026/08/31", "", aug_items, remarks=aug_remarks)
